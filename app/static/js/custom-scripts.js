   ...
   if ( $(".main-header").attr('data-sticky_header')) {
    ...
    if($('#contact-form').length) {
        ...
        var $contact_form = $("#contact-form"),
              $contact_submit_btn = $contact_form.find("button.btn-custom"),
              $user_name = $contact_form.find("#user_name"),
              $user_email = $contact_form.find("#user_email"),
              $email_subject = $contact_form.find("#email_subject"),
              $email_message = $contact_form.find("#email_message");
